...
<link
    rel="stylesheet"
    href="<?= escape(APP_URL) ?>/assets/css/locations.css?v=1"
>
...
<section class="locations-page" dir="rtl">
    <div class="locations-page-header">
        <div>
            <p class="locations-eyebrow">ניהול המחסן</p>
    ...
    <div class="locations-stats" aria-label="סטטיסטיקות מיקומים">
        <article class="location-stat-card">
            <div class="location-stat-icon" aria-hidden="true">📍</div>

            <div>
                <span class="location-stat-label">סה״כ מיקומים</span>
                <strong id="locationsTotalCount">0</strong>
            </div>
        </article>
        ...
        <article class="location-stat-card">
            ...
            <div>
                <span class="location-stat-label">פעילים</span>
                <strong id="locationsActiveCount">0</strong>
            </div>
        </article>
        ...
        <article class="location-stat-card">
            ...
            <div>
                <span class="location-stat-label">מושבתים</span>
                <strong id="locationsInactiveCount">0</strong>
            </div>
        </article>
        ...
        <article class="location-stat-card">
            ...
            <div>
                <span class="location-stat-label">מיקומי שורש</span>
                <strong id="locationsRootCount">0</strong>
            </div>
        </article>
    </div>
    ...
    <div
        ...
        role="status"
    >
        <span class="locations-spinner" aria-hidden="true"></span>
        <span>טוען מיקומים...</span>
    </div>
    ...
    <div
        ...
        hidden
    >
        <div class="locations-empty-icon" aria-hidden="true">📍</div>

        <h2>לא נמצאו מיקומים</h2>
        ...
        <form id="locationForm" novalidate>
            ...
            <div class="location-form-grid">
                <div class="form-group location-form-full">
                    ...
                    <small class="form-error" id="locationNameError"></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small class="form-error" id="locationCodeError"></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small class="form-error" id="locationTypeError"></small>
                </div>
...
<script
    src="<?= escape(APP_URL) ?>/assets/js/locations.js?v=1"
    defer
></script>
